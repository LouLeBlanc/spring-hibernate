package edu.brandeis.rseg105.hibernate.config;
 ...
 * Louis LeBlanc: Re-configured for edu.brandeis.rseg105.hibernate.config package. 11/9/18
 */
@Configuration
@PropertySource("classpath:db/jdbc.properties")
@ComponentScan(basePackages = "edu.brandeis.rseg105.hibernate")
